...
// /**
//  * Tools are declared here and exposed to the main agent.
//  * IMPORTANT:
...
//       sql: z
//         .string()
//         .describe('A valid DuckDB SQL query. Reference tables by their sanitized names.'),
//       reasoning: z
//         .string()
//         .describe('One short sentence explaining why this query answers the user\'s question.'),
//     }),
...
//       return { code, title, kind: 'svg-chart' as const };
//     },
//   }),
...
//           z.object({
//             heading: z.string(),
//             narrative: z.string().describe('1–3 sentence narrative for this section.'),
//             table: z
//               .array(z.record(z.string(), z.any()))
//               .optional()
...
//     }),
//     execute: async ({ title, filename, outline, executiveSummary }) => {
//       const userPrompt = `Title: ${title}
// Filename: ${filename}
...
//       const code = stripCodeFences(text);
//       return { code, title, filename, kind: 'pdf-report' as const };
//     },
//   }),
// };
